...
{
    public partial class Functie_exponentiala_supraunitara : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            a = (float)Double.Parse(textBox2.Text);
            ...
            double Y;
            Y = (double)y;
            maxim = (float)Math.Pow(A, Y);
            minim = (float)Math.Pow(A, X);
            textBox5.Text = Convert.ToString(maxim);
            textBox4.Text = Convert.ToString(minim);
            pictureBox1.Refresh();
        }

        
        public Functie_exponentiala_supraunitara()
        {
            InitializeComponent();
            Bitmap Img;
